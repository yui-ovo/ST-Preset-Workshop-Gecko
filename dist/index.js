...
const EXTENSION_VERSION = '2.99.0';
...
function buildRuntimeDocument() {
  ...
  const workshopUrl = new URL('./workshop-v2.99.js', import.meta.url).href;
...
export async function startPresetWorkshop() {
  ...
  iframe.addEventListener('load', () => {
    console.info(`[${EXTENSION_NAME}] GitHub 扩展运行环境已启动（v2.99 Gecko）`);
  }, { once: true });
