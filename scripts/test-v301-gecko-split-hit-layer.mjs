...
assert.ok(entry.includes("const EXTENSION_VERSION = '3.0.1'"), 'Gecko 扩展版本号不是 3.0.1');
assert.ok(entry.includes("new URL('./workshop-v3.01.js', import.meta.url)"), '启动器没有指向 v3.01 业务入口');
