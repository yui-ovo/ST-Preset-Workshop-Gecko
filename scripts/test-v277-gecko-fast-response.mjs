...
assert.ok(entry.includes("const EXTENSION_VERSION = '2.81.1'"), 'Gecko 扩展版本号不是 2.81.1');
assert.ok(entry.includes("new URL('./workshop-v2.81.js', import.meta.url)"), '启动器没有指向 v2.81 业务入口');
