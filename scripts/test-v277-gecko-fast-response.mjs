...
assert.ok(entry.includes("const EXTENSION_VERSION = '2.87.1'"), 'Gecko 扩展版本号不是 2.87.1');
assert.ok(entry.includes("new URL('./workshop-v2.87.js', import.meta.url)"), '启动器没有指向 v2.87 业务入口');
