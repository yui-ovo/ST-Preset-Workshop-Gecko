...
assert.ok(entry.includes("const EXTENSION_VERSION = '2.77.1'"), 'Gecko 扩展版本号不是 2.77.1');
assert.ok(entry.includes("new URL('./workshop-v2.77.js', import.meta.url)"), '启动器没有指向 v2.77 业务入口');
