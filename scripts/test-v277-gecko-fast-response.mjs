...
assert.ok(entry.includes("const EXTENSION_VERSION = '2.92.0'"), 'Gecko 扩展版本号不是 2.92.0');
assert.ok(entry.includes("new URL('./workshop-v2.92.js', import.meta.url)"), '启动器没有指向 v2.92 业务入口');
